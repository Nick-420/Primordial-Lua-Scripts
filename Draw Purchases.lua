...
local font = render.create_font("Arial", 14, 0)
...
local color_white = color_t(255, 255, 255, 255)
...
callbacks.add(e_callbacks.PAINT, function(e)
    ...
    local time_since_start = global_vars.cur_time()-round_start_time
    ...
    local x = screen_size.x-width_max-16-11
    local y = screen_size.y/2.3
